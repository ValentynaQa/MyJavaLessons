...
import java.util.Set; /* HW-7 */

public abstract class Pet {
    /*Опис класу Pet*/
    private HW6.SpeisesHW6 species;
    ...
    public Pet(HW6.SpeisesHW6 species, String nickname) {
        this.species = species;
        this.nickname = nickname;
    }

    /* конструктор "описывающий все поля животного"*/
    public Pet(HW6.SpeisesHW6 species, String nickname, int age, int trickLevel, Set<String> habits) { /* HW-7 */
        this.species = species;
        this.nickname = nickname;
        this.age = age;
    ...
    /* геттери*/
    public HW6.SpeisesHW6 getSpecies() {
        return species;
    }
