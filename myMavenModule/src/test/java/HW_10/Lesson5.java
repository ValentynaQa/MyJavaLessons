...
public class Lesson5 {
    public static void main(String[] args) {
        ...
        HW_10.Human fatherN = new HW_10.Human("Nazar", "Vasylenko", 32, Map.of("З Понеділка по П'ятницю", "Робота", "Субота", "Час для родини", "Неділя", "Похід в кіно").size());
        HW_10.Human motherV = new HW_10.Human("Valentyna", "Vasylenko", 28, 85);
        HW_10.Human childS = new HW_10.Human("Sosia", "Gryn", 5, Map.of("Вівторок", "Похід до лікаря").size());
        ...
        HW_10.Human child = new HW_10.Human("Sam", "Doe", 0, 0);
